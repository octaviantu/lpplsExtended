...
class ScorePreviousResults(TypeCheckBase):
    ...
    def main() -> None:
        ...
        ScorePreviousResults.write_strategy_results(tao_strategy_results, first_call=True)

        # Prepare and write data for LpplsSuggestions
        ScorePreviousResults.write_strategy_results(lppls_strategy_results, first_call=False)
