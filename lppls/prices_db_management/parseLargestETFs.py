...
def fetch_and_store_pricing_history():
    ...
    for ticker, etf in tickers:
        ...
        for index, row in pricing_history.iterrows():
            ...
            """, (index, ticker, 'ETF', etf, row['Open'], row['High'], row['Low'], row['Adj Close'], row['Volume']))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--fetch-tickers", action="store_true", help="Fetch all the tickers for the largest and most traaded ETFs")
